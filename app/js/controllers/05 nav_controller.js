...
.controller('NavCtrl', ['$scope','$timeout','$log','$uibModal','$http','Auth','$state','$localStorage','$location','$window', function($scope, $timeout,$log, $uibModal, $http, Auth, $state, $localStorage, $location, $window){
