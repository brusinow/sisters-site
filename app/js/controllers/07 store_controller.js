angular.module('SistersCtrls')
  ...
  .controller('StoreCtrl', ["$scope", "$state", "$http", "$timeout", "$location", "$sessionStorage", "allProducts", "Auth", function ($scope, $state, $http, $timeout, $location, $sessionStorage, allProducts, Auth) {
  ...
  .controller('StoreCartCtrl', ["$scope", "$state", "$http", "$timeout", "$location", "$sessionStorage", "$stateParams", function ($scope, $state, $http, $timeout, $location, $sessionStorage, $stateParams) {
    var main = document.getElementById("main");
    main.style.backgroundColor = 'rgba(255,255,255,0)';
  ...
  .controller('StoreShowCtrl', ["$scope", "$rootScope", "$stateParams", "$state", "$http", "$timeout", "$location", "$sessionStorage", "oneProduct", function ($scope, $rootScope, $stateParams, $state, $http, $timeout, $location, $sessionStorage, oneProduct) {
    var main = document.getElementById("main");
  ...
  .controller('CheckoutTemplateCtrl', ["$scope", "$state", "$http", "$timeout", "$location", "$localStorage", function ($scope, $state, $http, $timeout, $location, $localStorage) {
    $scope.$emit('loadMainContainer', 'loaded');
  ...
  .controller('StoreAddressCtrl', ["$scope", "$state", "$window", "$timeout", "$http", "$location", "$localStorage", "ngCart", "$rootScope", "moment", "currentOrder", "shipment", function ($scope, $state, $window, $timeout, $http, $location, $localStorage, ngCart, $rootScope, moment, currentOrder, shipment) {
    var main = document.getElementById("main");
  ...
  .controller('StorePaymentCtrl', ["$scope", "$state", "$http", "$timeout", "$location", "$localStorage", "ngCart", "$rootScope", "currentOrder", "shipment", function ($scope, $state, $http, $timeout, $location, $localStorage, ngCart, $rootScope, currentOrder, shipment) {
  ...
  .controller('StoreConfirmCtrl', ["$scope", "$state", "$http", "$timeout", "$location", "$localStorage", "ngCart", "$rootScope", "currentOrder", "shipment", "currentToken", function ($scope, $state, $http, $timeout, $location, $localStorage, ngCart, $rootScope, currentOrder, shipment, currentToken) {
